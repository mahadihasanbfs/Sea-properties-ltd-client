...
const UserHistory = () => {
    ...
    const nextPage = () => {
        if (currentPage < Math.ceil(tableItems.length / itemsPerPage)) {
    ...
    const paginationNumbers = Array.from({ length: Math.ceil(tableItems.length / itemsPerPage) }, (_, i) => i + 1);
    ...
    return (
        <div className="pt-3">
            ...
            <div className="flex justify-center mt-4">
                ...
                <button onClick={nextPage} className="mx-1 px-3 py-1 rounded bg-gray-200 text-[#d8d8d8] bg-[blue]" disabled={currentPage === Math.ceil(tableItems.length / itemsPerPage)}>Next</button>
            </div>
        </div>
    );
};
