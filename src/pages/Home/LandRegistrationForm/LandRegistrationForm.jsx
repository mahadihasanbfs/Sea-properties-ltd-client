                ...
                <form onSubmit={handleSubmit} className='space-y-4'>
                    ...
                    <div className='flex justify-center gap-[590px] mt-[110px!important]'>
                        < div className='flex flex-col items-center'>
                            <input name='authorizedSignature' type="text" className='border-b focus:outline-none bg-transparent border-black px-2' />
                            <p>Authorized Signature</p>
                        </div>
                        < div className='flex flex-col items-center'>
                            <input name='sharersSignature' type="text" className='border-b focus:outline-none bg-transparent border-black px-2' />
