...
const SecondaryBanner = ({ bannerImg, opacity, projectName, location }) => {
    return (
        <div
            ...
            className="h-[400px] md:h-[500px] lg:h-[768px] bg-cover bg-center uppercase text-white text-left flex flex-col justify-center gap-[20px] font-normal md:pl-20 xl:pl-[180px]">
